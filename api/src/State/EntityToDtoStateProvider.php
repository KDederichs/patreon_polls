...
readonly class EntityToDtoStateProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): object|array|null
    {
        ...
        $mapperContext = $context + ['poll_isCollection' => $operation instanceof CollectionOperationInterface];
        if ($operation instanceof CollectionOperationInterface) {
            $entities = $this->collectionProvider->provide($operation, $uriVariables, $context);
            $dtos = [];
            foreach ($entities as $entity) {
                $dtos[] = $this->mapEntityToDto($entity, $resourceClass, $mapperContext);
            }
        ...
        return $this->mapEntityToDto($entity, $resourceClass, $mapperContext);
    }
