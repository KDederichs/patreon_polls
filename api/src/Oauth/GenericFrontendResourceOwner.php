...
abstract class GenericFrontendResourceOwner extends GenericOAuth2ResourceOwner
{
    ...
    protected abstract function substituteRedirectUri(string $redirectUri): string;
}
