    ...
    <div className="flex h-full w-full items-center justify-center">
      <div className="flex w-full max-w-md flex-col gap-4 rounded-large bg-content1 px-8 pb-10 pt-6 shadow-small">
        {authSuccess === undefined ? (
          <>
            <p className="pb-2 text-xl font-medium">Please wait while we authenticate you and do not close this window...</p>
        ...
        {authSuccess === true ? (
          <>
            {mode === 'login' ? (<p className="pb-2 text-xl font-medium">
